        ...
        <div className="container">
          ...
          <div className="footer-quick-link-wrap">
            <div className="row align-items-center">
              <div className="col-md-5">
                <div className="">
                  <ul className='flex flex-wrap justify-start items-start gap-5'>
                    <li><a href="/imprint" className='text-white'>Imprint</a></li>
              ...
              <div className="col-md-4  lg:py-1 py-3">
                <span className='uppercase r text-xl '>Official <span className='text-red-500'>X</span><span className='text-gray-700'>HAMSTER</span> Talent Scout</span>

...
function RegisterStepThree() {
    return (
        <div style={{ backgroundImage: `url(${registerBackgroundsteptwoImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>

            <div style={{ backgroundImage: `url(${registerBackgroundsteptwoImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }} className="bg-black h-full flex flex-col items-center justify-center">
                    ...
                    <div className="  gap-5 mt-54 overflow-hidden">
                        ...
                        <div className=' flex flex-wrap gap-3 mx-auto justify-center items-center' >
                            ...
                            <a href="#" className="flex flex-col items-center group gap-2">
                                <img className="rounded border-2 border-transparent group-hover:border-2 group-hover:border-gray-300 h-24 w-24" src="https://picsum.photos/seed/a/150/150" />
                                <p className="text-gray-500 group-hover:text-gray-300"> Tiffany </p>
                            </a>


                            <a href="#" className="flex flex-col items-center group gap-2">
                                <img className="rounded border-2 border-transparent group-hover:border-2 group-hover:border-gray-300 h-24 w-24" src="https://picsum.photos/seed/b/150/150" />
                                <p className="text-gray-500 group-hover:text-gray-300"> Jessica </p>
                            </a>


                            <a href="#" className="flex flex-col items-center group gap-2">
                                <img className="rounded border-2 border-transparent group-hover:border-2 group-hover:border-gray-300 h-24 w-24" src="https://picsum.photos/seed/c/150/150" />
                            ...
                            <a href="#" className="flex flex-col items-center group gap-2">
                                <img className="rounded border-2 border-transparent group-hover:border-2 group-hover:border-gray-300 h-24 w-24" src="https://picsum.photos/seed/d/150/150" />
                            ...
                            <a href="#" className="flex flex-col items-center group gap-3 ">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-[100px] w-[100px] group-hover:bg-gray-300 border-2 border-transparent" viewBox="0 0 20 20" fill="#6b7280">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd" />
                                </svg>
                                <p className="text-gray-500 group-hover:text-gray-300"> Upload 10 Pictures </p>
                            </a>
                ...
                <div className='flex flex-wrap'>
                    <div className="px-4 py-1 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-1 lg:px-1 lg:py-5">
                        <div className="relative mb-6 sm:mx-auto md:mb-10 md:max-w-md lg:max-w-lg">
                            <img className="object-cover w-full h-56 rounded shadow-lg md:h-36 lg:h-44" src="https://images.pexels.com/photos/927022/pexels-photo-927022.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=3&amp;h=750&amp;w=1260" alt="" />

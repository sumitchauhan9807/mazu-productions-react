...
//   return (
//     <div>
//       <h1>Welcome to My React Template</h1>
        ...
        <div>
            <div>
                ...
                <span className="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg border-2 border-white">in</span>
                            ...
                            <form action className="sm:w-2/3 w-full px-4 grid grid-cols-2 lg:px-0 mx-auto">
                                <div className="pb-2 pt-4">
                                    <input type="text" name="First Name" placeholder="First Name" className="block w-full p-4 text-lg rounded-sm bg-black" />
                                </div>  <div className="pb-2 pt-4">
                                    <input type="text" name="Last Name" placeholder="Last Name" className="block w-full p-4 text-lg rounded-sm bg-black" />
                                </div>

                                <div className="pb-2 pt-4">
                                    <input type="text" name="username" placeholder="Username" className="block w-full p-4 text-lg rounded-sm bg-black" />
                                </div>
                                <div className="pb-2 pt-4">
                                ...
                                <div className="pb-2 pt-4">
                                    <input className="block w-full p-4 text-lg rounded-sm bg-black" type="password" name=" Re enter Password" id="password" placeholder="Re enter Password" />
                                </div>
                            ...
                            </form>  <div className="text-center text-gray-400 hover:underline hover:text-gray-100">
                                    <a href="#">Forgot your password?</a>
                                </div>
                            <div className='w-96 flex mx-auto justify-center items-center'>
                           
                                <div className="px-4 pb-2 pt-4">
                                    <button className="uppercase block w-full p-4 text-lg rounded-full text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none">register now</button>
                                </div>
                            </div>
                        </div>
                    </div>

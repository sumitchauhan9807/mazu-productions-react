...
function TranslMovies() {
  const [activeCategory, setActiveCategory] = useState('Trans');
          ...
          <div className="col-lg-6 lg:block hidden">
            <div className="ucm-nav-wrap">
              <ul className="nav nav-tabs" id="myTab" role="tablist">
                <CategorySelect
                  name={'Trans'}
                  active={activeCategory === 'Trans'}
                  onClick={() => handleCategoryChange('Trans')}
                />
